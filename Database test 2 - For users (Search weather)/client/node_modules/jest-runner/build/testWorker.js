'use strict';
/* build-hook-start *//*00001*/try { require('c:\\Users\\angry\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.371\\out\\buildHook\\index.js').default({tool: 'jest', checkSum: '20b777032ebde1c3b4e3a7UAAZAh4CCFdQAVxQUAABVlQDBwYA', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/angry/.vscode/extensions/wallabyjs.console-ninja-1.0.371/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '20b777032ebde1c3b4e3a7UAAZAh4CCFdQAVxQUAABVlQDBwYA', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('c:\\Users\\angry\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.371\\out\\buildHook\\index.js').default({tool: 'webpack', checkSum: '20283de79a996351c66e3eBxYKUksGAwQBCwcHBlBRVFVcBl0H', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/angry/.vscode/extensions/wallabyjs.console-ninja-1.0.371/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20283de79a996351c66e3eBxYKUksGAwQBCwcHBlBRVFVcBl0H', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
